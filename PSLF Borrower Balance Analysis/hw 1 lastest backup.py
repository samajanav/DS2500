...
# -*- coding: utf-8 -*-
"""
Created on Fri Sep 29 17:37:17 2023
...
def main():
    ...
    for i in range(len(ct_balance_values)):
        ...
        plot_values_ct = average_balance_1
    ...
    for i in range(len(dl_balance_values)):
        ...
        plot_values_dl = average_balance_2
    
    # plt.plot(average_balance_1, label='CT Average Balance', linestyle='-', marker='o', markersize=6, color='b')
    # plt.plot(average_balance_2, label='DL Average Balance', linestyle='-', marker='s', markersize=6, color='g')
